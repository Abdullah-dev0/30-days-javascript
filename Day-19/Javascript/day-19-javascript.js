...
const string1 = "JavaScript is a versatile language. JavaScript can be used for front-end and back-end development.";
...
const string2 = "The year is 2024, and the month is 08.";
...
function matchCapitalizedWords(str) {
	const regex = /\b[A-Z][a-z]*\b/g;
	return str.match(regex);
}

const string3 = "Alice and Bob went to the Wonderland.";
...
const string4 = "The address is 123 Main Street, Apt 4B.";
...
function capturePhoneNumberComponents(phone) {
...
const string6 = "Welcome to the new world";
