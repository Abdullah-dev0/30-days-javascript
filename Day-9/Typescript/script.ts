...
const changeContent: HTMLElement | null = document.getElementById("task-1");

changeContent!.innerHTML = "Hey my name is Jhon Doe";

// Task 2 : Select an Html element by its class and change its background color.

const changeBackgroundColour = document.getElementsByClassName("task-2") as HTMLCollectionOf<HTMLElement>;

changeBackgroundColour[0].style.backgroundColor = "red";

// -------------- or you can also use querySelector --------

const changeBackgroundColour2: HTMLInputElement | null = document.querySelector(".task-2");
...
const newList: HTMLElement = document.createElement("li");

const getUl: HTMLElement | null = document.getElementById("task-4");
...
const removeElement: HTMLElement | null = document.getElementById("task-5");

removeElement!.remove();

// Task 6: Remove the last child of a specific HTMl Element.

const removeLastChild: HTMLElement | null = document.getElementById("task-4");
...
const changeAttribute = document.getElementById("task-7") as HTMLImageElement;
...
const addAndRemoveClass: HTMLElement | null = document.getElementById("task-8");
...
const getButtonById = document.getElementById("task-9") as HTMLButtonElement;
const getContent: HTMLElement | null = document.getElementById("contentToChange");

getButtonById!.addEventListener("click", (event: MouseEvent) => {
	getContent!.innerHTML = "Content changed";
});

// Task 10: add a mouseover event listener to an element that change its border color.

const changeBroderColor: HTMLElement | null = document.getElementById("task-10");

changeBroderColor!.addEventListener("mouseover", function (event: MouseEvent) {
