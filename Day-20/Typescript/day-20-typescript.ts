...
const userObject: User = { name: "John Doe", email: "john@example.com" };
...
document.addEventListener("DOMContentLoaded", () => {
	const form = document.querySelector("#localStorageForm") as HTMLFormElement;
...
const sessionUserObject: User = { name: "Jane Doe", email: "jane@example.com" };
...
document.addEventListener("DOMContentLoaded", () => {
	const sessionForm = document.querySelector("#sessionForm") as HTMLFormElement;
	const sessionNameInput = document.querySelector("#sessionName") as HTMLInputElement;
	const sessionEmailInput = document.querySelector("#sessionEmail") as HTMLInputElement;
	const sessionDisplay = document.querySelector("#sessionDisplay") as HTMLDivElement;
...
function saveToBothStorages(key: string, value: string) {
