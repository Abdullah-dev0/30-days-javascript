...
function countCharacterOccurrences(str: string): { [key: string]: number } {
...
const array7: number[] = [1, 3, 5];
const array8: number[] = [2, 4, 6];
...
const weights: number[] = [1, 3, 4, 5];
const values: number[] = [1, 4, 5, 7];
