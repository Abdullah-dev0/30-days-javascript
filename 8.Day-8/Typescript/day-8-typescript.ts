...
const intro: string = `Helo my name is ${Name} and my age is ${age} and i Am a full Stack Developer`;
...
const multiLineSting: string = `Helo Guyz 
my name is Abdullah
and my age is 23 
...
const array: number[] = [1, 23, 3, 4, 5, 5];
...
const newArray: number[] = [...array2, 4, 5, 6, 7];
...
function product(num1: number, num2 = 1) {
	return num1 * num2;
}

console.log("Product with both parameters = ", product(2, 22));

function product2(num1: number, num2 = 1) {
	return num1 * num2;
}
